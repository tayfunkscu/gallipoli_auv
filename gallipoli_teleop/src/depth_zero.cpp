...
int main(int argc, char **argv)
{
    ...
    while (ros::ok())
    {
        vertical_pwm.m1 = 1500 - depth.data * 250;
        vertical_pwm.m2 = 1500 - depth.data * 250;
        vertical_pwm.m3 = 1500 - depth.data * 250;
        vertical_pwm.m4 = 1500 - depth.data * 250;
